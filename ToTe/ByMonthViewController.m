...
- (void)viewDidLoad
{
    ...
    //we created calendar it contains componets like hour,year,month,day. then lets extract these components from Calendar using NSDateComponents.
    ...
    //[ChartUiImageView setHidden:NO];
    self.navigationItem.title = [months objectAtIndex:[Components month]-1];
...
{
    [customDate setHidden:YES];
    if (btnCalendar.image != [UIImage imageNamed:@"glyphicons_045_calendar.png"])
    {
        btnCalendar.image = [UIImage imageNamed:@"glyphicons_045_calendar.png"];
    }
    //[ChartUiImageView setAlpha:1];
}

- (IBAction)btnCalender:(id)sender
{
    if (btnCalendar.image != [UIImage imageNamed:@"glyphicons_193_circle_ok.png"])
    {
        [customDate setHidden:NO];
        btnCalendar.image = [UIImage imageNamed:@"glyphicons_193_circle_ok.png"];
        //[ChartUiImageView setAlpha:0.1];
    ...
    else
    {
        ...
        NSInteger selectedRow = [customDate selectedRowInComponent:0];
        
        NSString *selectedTitle = [customDate titleForRow:selectedRow forComponent:0];
